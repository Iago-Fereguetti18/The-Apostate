...
half4 CombinedShapeLightShared(in SurfaceData2D surfaceData, in InputData2D inputData)
{
    ...
    half4 shapeLight3Modulate = visionMask * _ShapeLightBlendFactors3.x;
    half4 shapeLight3Additive = visionMask * _ShapeLightBlendFactors3.y;
#else
    ...
    finalOutput.a = min(alpha * visionMask, 1.0);
